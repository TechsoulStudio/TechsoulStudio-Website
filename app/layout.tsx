...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "logo design company surat",
    "professional logo design surat",
    "custom logo design surat",
    "business logo design surat",
    "creative logo designer surat",
    "brand logo design surat",
    "logo maker surat",
    "affordable logo design surat",
